      ...
      <section id="services">
        <div className="w-full flex flex-col justify-center items-center bg-blue-900 h-fit">
          <div className="md:w-[85%] w-full mx-auto flex md:flex-row flex-col justify-center items-start md:gap-6 gap-20 md:p-20 p-10 mt-[-200px] z-20">
            ...
            >
              <img src={phi1} alt="image" width={300} height={300} />
              <h1 className="text-4xl text-white fort-semibold">
                Bodybuilding
              </h1>
              ...
              <button className="px-6 py-3 bg-red-500 text-white font-semibold transform hover:scale-105 transition-transform duration-300 cursor-pointer">
                VIEW MORE
              </button>
            </div>
