        ...
        <div className="w-full flex flex-col justify-center items-center gap-2 bg-blue-900 h-fit pb-20">
          <div className="md:w-[85%]  w-full mx-auto grid md:grid-cols-3 grid-cols-1 justify-center items-center md:gap-20 gap-10 md:p-20 p-10 mt-[-200px] z-20">
            ...
            >
              ...
              <h1 className="text-2xl text-slate-500">Address</h1>
              <p className="text-center text-lg">
                121 Rock Street, 21 Avenu, New York, NY 92103-9000
              </p>
            </div>
            ...
            >
              ...
              <h1 className="text-2xl text-slate-500">Email Us</h1>
            ...
            >
              ...
              <h1 className="text-2xl text-slate-500">Call Us</h1>
              <div className="flex flex-col justify-center items-center">
                <p className="text-center text-lg">+91 983 9839 393</p>
                <p className="text-center text-lg">+91 983 9839 393</p>
              </div>
            </div>
          </div>
          <button className="px-6 py-3 bg-red-500 text-white font-semibold">
            VIEW MORE
          </button>
        </div>
      </section>
